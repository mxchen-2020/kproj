...
#plot,ylim[,]                          #y-axis(ENERGY RANGE)
factor = 50                            #Control the size of the point           ↓
plt.scatter(KPOINT_PLOT,EIGENV_PLOT,alpha=WEIGHT_PLOT,c="black",s=WEIGHT_PLOT*factor,marker='o')
for i in range(KSPLIT):                #High SYMMETRY POINT
