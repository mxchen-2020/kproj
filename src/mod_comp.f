...
!        INTEGER, PARAMETER  :: fp=SELECTED_REAL_KIND(13)
     ...
     &           BOLKEV=8.6173857E-5_DP,BOLK=BOLKEV*EVTOJ, HPLANK=6.6262E-34_DP
         ...
         integer,parameter,public  :: IUW=3  ! WAVEFUNCTION
...
!        IUEG = 4   ! energy band
     ...
     & a(2,3)*a(3,2)*a(1,1)-a(3,3)* &
         a(1,2)*a(2,1)
       END subroutine determ_input


        subroutine invert_input(mat1,inv_mat1)
        !!! invert of matrix
        REAL(DP)        :: inv_mat1(3,3),det
        INTEGER         :: mat1(3,3)
        ...
        call determ_input(mat1,det)
        inv_mat1(1:3,1:3)=inv_mat1(1:3,1:3)/det
        end subroutine invert_input
