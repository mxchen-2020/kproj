   ...
   do J=1,ions_type(I)
      do K=1,ions_n(I,J)
         ...
         do IDIR=1,3
            ...
            C_PHONON(IKPOINT,IBAND,I,J,K,IDIR)=cmplx(real_vector,im_vector)
         enddo
      enddo
   enddo
enddo
      ...
      DO IBAND = 1,NBAND 
         DO I= 1,part
            DO J = 1,ions_type(I)
               DO IDIR = 1, 3 !xyz
                  DO K= 1, ions_n(I,J)
                     WEIGHT_TEMP=WEIGHT_TEMP+C_PHONON(IKPOINT,IBAND,I,J,K,IDIR)!*exp(-TWOPI*im*dot_product(KPOINT_CARTESIAN(IKPOINT,:),POS_MAP_CARTESIAN(I,J,:)))
                  ENDDO
